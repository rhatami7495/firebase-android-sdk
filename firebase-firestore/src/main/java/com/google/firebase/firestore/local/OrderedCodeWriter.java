...
public class OrderedCodeWriter {
    ...
    /** Creates a new writer with an initial buffer size. */
    public OrderedCodeWriter(int bufferSize) {
        buffer = new byte[bufferSize];
    }

    public void writeBytesAscending(byte[] value) {
        for (byte b : value) {
    ...
    public void writeBytesDescending(byte[] value) {
        for (byte b : value) {
